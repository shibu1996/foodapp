 ...
 */
const sendOrderConfirmation = async (to: string, data: any) => {
 ...
 */
const sendOrderStatusUpdate = async (to: string, data: any) => {
 ...
 */
const sendOrderCancellation = async (to: string, data: any) => {
 ...
 */
const sendOrderDelivered = async (to: string, data: any) => {
 ...
 */
const sendFeedbackRequest = async (to: string, data: any) => {
 ...
 */
const sendSubscriptionConfirmation = async (to: string, data: any) => {
 ...
 */
const sendSubscriptionReminder = async (to: string, data: any) => {
 ...
 * Send OTP email
 */
const sendOTPEmail = async (to: string, data: any) => {
